        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 flex items-center relative">
          ...
          <nav className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-1">
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-base font-semibold text-white/80 hover:text-[#20b2f5] hover:bg-white/10 transition-all whitespace-nowrap"
            >
            ...
            <NavLink
              to="/our-team"
              className={({ isActive }) => `inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-base font-semibold transition-all whitespace-nowrap ${isActive ? 'text-white bg-white/15' : 'text-white/80 hover:text-[#20b2f5] hover:bg-white/10'}`}
            >
